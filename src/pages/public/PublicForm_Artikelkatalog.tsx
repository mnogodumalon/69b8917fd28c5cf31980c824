...
const PROXY_BASE = '';
const APP_ID = '69b8916378e0e1c2eef5283c';
...
export default function PublicFormArtikelkatalog() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Artikelkatalog — Formular</h1>
        </div>
