...
export class LivingAppsService {
  ...
  static async createRechnungspositionenEntry(fields: Rechnungspositionen['fields']) {
    return callApi('POST', `/apps/${APP_IDS.RECHNUNGSPOSITIONEN}/records`, { fields });
  }
  static async updateRechnungspositionenEntry(id: string, fields: Partial<Rechnungspositionen['fields']>) {
    return callApi('PATCH', `/apps/${APP_IDS.RECHNUNGSPOSITIONEN}/records/${id}`, { fields });
  }
  ...
  static async createArtikelkatalogEntry(fields: Artikelkatalog['fields']) {
    return callApi('POST', `/apps/${APP_IDS.ARTIKELKATALOG}/records`, { fields });
  }
  static async updateArtikelkatalogEntry(id: string, fields: Partial<Artikelkatalog['fields']>) {
    return callApi('PATCH', `/apps/${APP_IDS.ARTIKELKATALOG}/records/${id}`, { fields });
  }
